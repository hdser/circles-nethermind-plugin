...
COPY --from=build /circles-nethermind-plugin/Circles.Index.EventSourcing.dll /nethermind/plugins
COPY --from=build /circles-nethermind-plugin/Circles.Index.EventSourcing.pdb /nethermind/plugins
COPY --from=build /circles-nethermind-plugin/Circles.Index.Graphs.dll /nethermind/plugins
COPY --from=build /circles-nethermind-plugin/Circles.Index.Graphs.pdb /nethermind/plugins
...
COPY --from=build /circles-nethermind-plugin/runtimes/linux-x64/native/google-ortools-native.so /nethermind/plugins
COPY --from=build /circles-nethermind-plugin/runtimes/linux-x64/native/libortools.so.9 /nethermind/plugins
